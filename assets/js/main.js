jQuery(
    (function ($) {
        ...
        $(".navbar .navbar-nav li a").on("click", function (e) {
            ...
            $("html, body")
                .stop()
                .animate({ scrollTop: $(anchor.attr("href")).offset().top - 100 }, 100);
            e.preventDefault();
        });
        ...
        const $imagesSlider = $(".testimonial-slides .client-feedback>div"),
        ...
        function submitMSGSub(valid, msg) {
            if (valid) {
                let msgClasses = "validation-success";
            } else {
                let msgClasses = "validation-danger";
            }
